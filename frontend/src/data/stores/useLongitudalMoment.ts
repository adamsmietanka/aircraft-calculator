...
export const useLongitudalMomentStore = create<LongitudalMomentState>()(
  (set) => ({
    ...
    l_bf_g: 3,
    i_w_g: 1,
    setS_b_g: (value) => set((state) => ({ s_b_g: value })),
    setS_bf_g: (value) => set((state) => ({ s_bf_g: value })),
    setW_g: (value) => set((state) => ({ w_g: value })),
    setL_b_g: (value) => set((state) => ({ l_b_g: value })),
    setL_bf_g: (value) => set((state) => ({ l_bf_g: value })),
    setI_w_g: (value) => set((state) => ({ i_w_g: value })),
    ...
    c_0: 2.6,
    b_k: 0.97,
    setS_b: (value) => set((state) => ({ s_b: value })),
